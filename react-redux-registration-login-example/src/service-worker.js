...
export function register(config) {
    if ('serviceWorker' in navigator) {
        // The URL constructor is available in all browsers that support Service Worker.
        const publicUrl = new URL(publicConstants.PUBLIC_URL, window.location.href);
        ...
        window.addEventListener('load', () => {
            const serviceWorkerFileName = process.env.NODE_ENV === 'production' ? 'service-worker.js' : 'custom-service-worker.js';
